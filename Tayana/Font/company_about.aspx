<%@ Page Title="" Language="C#" MasterPageFile="~/Font/Site3.Master" AutoEventWireup="true" CodeBehind="company_about.aspx.cs" Inherits="Tayana.Font.company_about" %>
...
<asp:Content ID="Content7" ContentPlaceHolderID="ContentPlaceHolder5" runat="server">
    <div class="box2_list">
        <div class="box3">
            <asp:Literal ID="AboutContent" runat="server"></asp:Literal>
        </div>
    </div>
</asp:Content>
